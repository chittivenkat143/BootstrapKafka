...
public class MessageConsumerOffsetRebalance {

    private static final Logger logger = LoggerFactory.getLogger(MessageConsumerOffsetRebalance.class.getName());
    ...
    public MessageConsumerOffsetRebalance(Map<String, Object> prop) {
    ...
    public static void main(String[] args) {
        MessageConsumerOffsetRebalance consumer = new MessageConsumerOffsetRebalance(consumerProperties());
